...
int main(int argc, char* argv[]) {
    ...
    a.setApplicationUrl(tApplication::Sources, QUrl("https://github.com/theCheeseboard/thecalculator"));
    a.setApplicationUrl(tApplication::FileBug, QUrl("https://github.com/theCheeseboard/thecalculator/issues"));
    ...
    const QUrl url(u"qrc:/qt/qml/com/vicr123/thecalculator/Main.qml"_qs);
    QObject::connect(
